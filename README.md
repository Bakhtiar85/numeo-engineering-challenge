...
2. Spoken sentences are captured
3. Each sentence is sent to a backend via WebSocket / Socket.io
4. The backend makes a request to an AI API (e.g. OpenAI or any similar service, real or mocked)
5. The translated text is returned and displayed in the UI in real time
...
2. Screen recording video (Google Drive / Loom / unlisted YouTube)
